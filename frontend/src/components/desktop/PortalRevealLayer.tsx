...
export default function PortalRevealLayer({
  ...
  return (
    <div
      ref={portalLayerRef}
      className="fixed inset-0 z-10 flex flex-col justify-center items-center px-6 sm:px-12 pointer-events-auto select-none bg-gradient-to-b from-[#080b11] via-[#050608] to-[#040507] opacity-0 will-change-transform overflow-hidden"
      style={{ transform: 'scale(0.92)' }}
    >
      {/* Ambient Celestial Warm Gold Radiance (Desktop only) */}
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-radial from-[#d4af37]/20 via-[#fbf5b7]/10 to-transparent blur-[130px] pointer-events-none" />
